(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/material'), require('@angular/material/core'), require('@angular/cdk/a11y'), require('@angular/cdk/overlay'), require('@angular/common'), require('@angular/cdk/keycodes'), require('@angular/animations'), require('@angular/cdk/bidi'), require('@angular/cdk/coercion'), require('@angular/cdk/portal'), require('@angular/material/dialog'), require('@angular/platform-browser'), require('rxjs/Subject'), require('rxjs/Subscription'), require('rxjs/observable/merge'), require('rxjs/observable/of'), require('@angular/forms'), require('@angular/material/form-field')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/material', '@angular/material/core', '@angular/cdk/a11y', '@angular/cdk/overlay', '@angular/common', '@angular/cdk/keycodes', '@angular/animations', '@angular/cdk/bidi', '@angular/cdk/coercion', '@angular/cdk/portal', '@angular/material/dialog', '@angular/platform-browser', 'rxjs/Subject', 'rxjs/Subscription', 'rxjs/observable/merge', 'rxjs/observable/of', '@angular/forms', '@angular/material/form-field'], factory) :
	(factory((global.core = {}),global.ng.core,global.ng.material,global.ng.material,global.ng.cdk.a11y,global.ng.cdk.overlay,global.ng.common,global.ng.cdk.keycodes,global.ng.animations,global.ng.cdk.bidi,global.ng.cdk.coercion,global.ng.cdk.portal,global.ng.material,global.ng.platformBrowser,global.Rx,global.Rx,global.Rx.Observable,global.Rx.Observable,global.ng.forms,global.ng.material));
}(this, (function (exports,core,material,core$1,a11y,overlay,common,keycodes,animations,bidi,coercion,portal,dialog,platformBrowser,Subject,Subscription,merge,of,forms,formField) { 'use strict';
...
MatDatetimepickerContent.propDecorators = {
    '_calendar': [{ type: core.ViewChild, args: [MatDatetimepickerCalendar,] },],
};
var MatDatetimepicker = (function () {
    ...
    Object.defineProperty(MatDatetimepicker.prototype, "openOnFocus", {
         ...
         * @return {?}
         */
        set: function (value) { this._openOnFocus = coercion.coerceBooleanProperty(value); },
        enumerable: true,
        configurable: true
    });
    /**
...
MatDatetimepicker.ctorParameters = function () { return [
    ...
    { type: undefined, decorators: [{ type: core.Inject, args: [material.MAT_DATEPICKER_SCROLL_STRATEGY,] },] },
    { type: DatetimeAdapter, decorators: [{ type: core.Optional },] },
...
var MatDatetimepickerToggle = (function () {
    ...
    MatDatetimepickerToggle.prototype._watchStateChanges = function () {
        var _this = this;
        var /** @type {?} */ datepickerDisabled = this.datetimepicker ? this.datetimepicker._disabledChange : of.of();
        var /** @type {?} */ inputDisabled = this.datetimepicker && this.datetimepicker._datepickerInput ?
            this.datetimepicker._datepickerInput._disabledChange : of.of();
        this._stateChanges.unsubscribe();
...
var MAT_DATETIMEPICKER_VALUE_ACCESSOR = {
    ...
    useExisting: core.forwardRef(function () { return MatDatetimepickerInput; }),
    multi: true
};
...
var MatDatetimepickerInput = (function () {
     ...
     * @return {?}
     */
    MatDatetimepickerInput.prototype.getFormat = function () {
